...
\subsection*{System Overview}
	extbf{CoWriteIA} is an AI-assisted writing platform designed to support writers through various stages of the creative process. The system enables users to:\ \cite{notionai,grammarly,scrivener}
